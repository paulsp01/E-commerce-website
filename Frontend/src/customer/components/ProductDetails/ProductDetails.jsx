    ...
    <div className="pt-6">
      ...
      <div className="flex flex-col items-center">
        ...
        <img
          ...
          className="hidden size-full rounded-lg object-cover lg:block object-center"
        />
        </div>
        <div className="flex flex-wrap space-x-5 justify-center">
        {product.images.map((image)=><div className='mt-4 aspect-h-2 aspect-w-2 overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem]'>
          <img
            alt={image.alt}
            src={image.src}
     ...
     {/*Product Info*/ }
      <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-15 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
        <div className="lg:col-span-2 ">
          ...
          <p className='text-lg lg:text-xl text-gray-600 opacity-60 pt-1'>A Good Quality Shirt Free Size</p>
        </div>
        ...
        <div className="mt-4 lg:row-span-3 lg:mt-0">
          ...
          <p className=" line-through text-green-700 opacity-80">₹1234</p>
          <p className=" text-red-600">70% off</p>
          </div>
          ...
          <div className="mt-6">
            ...
            <p className='text-xs text-gray-600 opacity-80'>(36566 Ratings)</p>
            <p className='text-indigo-600 text-sm font-semibold hover:text-indigo-500 pl-3'>117 Reviews</p>
            </div>
